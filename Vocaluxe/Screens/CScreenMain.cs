...
{
    public class CScreenMain : CScreenMainCommunity
    {
        ...
        public override void Init()
        {
            ...
            base.Init();
            _ThemeStatics = MergeThemeElements("Static", new string[] { "StaticMenuBar", _StaticWarningProfiles });
            _ThemeButtons = MergeThemeElements("Button", new string[] { _ButtonSing, _ButtonParty, _ButtonOptions, _ButtonProfiles, _ButtonExit });
            _ThemeTexts = MergeThemeElements("Text", new string[] { _TextRelease, _TextWarningProfiles });
        }
